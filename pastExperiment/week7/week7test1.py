...
for f in range(0,30):
    ...
    bestX = bestIndex/999 * (stop-start) - stop # find location of best solution in the search space of this run
    start = bestX - 2.5 # Set new search space
    stop = bestX + 2.5 # Set new search space
